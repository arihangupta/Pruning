...
Runs baseline training with DINOv2 ViT-S/14 backbone + linear head on MedMNIST datasets.
Mimics the provided CNN script: trains for 10 epochs, evaluates on test, saves model, writes CSV summary.
No pruning.

Requires: torch, torchvision, numpy, transformers (optional), (scikit-learn optional for AUC)
...
def build_model(num_classes: int) -> nn.Module:
    ...
    # Load DINOv2 backbone (self-supervised pretrained)
